...
public class SampleView extends AbstractTimeGraphView {// extends CallStackView
    ...
    protected void buildEntryList(final ITmfTrace trace, final ITmfTrace parentTrace, final IProgressMonitor monitor) {
        ...
        ITimeEvent event = new EventNode("main", 37, 1, 7);//fRoot.getProfileData().getStartTime() + 1, fRoot.getProfileData().getEndTime() + 1);
    ...
    protected List<ITimeEvent> getEventList(TimeGraphEntry entry,  long startTime, long endTime, long resolution, IProgressMonitor monitor) {
        ...
        EventEntry queueNodesEntry = (EventEntry) entry;
    ...
    private void buildStatusEvents(ITmfTrace trace, EventEntry entry, @NonNull IProgressMonitor monitor, long start, long end) {
    ...
    public void createPartControl(Composite parent) {
        ...
        TmfTimeRange range = new TmfTimeRange(TmfTimestamp.fromNanos(0), TmfTimestamp.fromNanos(15000));
        broadcast(new TmfWindowRangeUpdatedSignal(SampleView.this, range));
        getTimeGraphViewer().setStartFinishTime(0, 15000);
